...
class CifarResNet(nn.Module):
  ...
  """
    ...
    """
        ...
        self.inplanes = 16
        self.branch_linearshape = [147456, 147456, 147456, 147456, 147456, 36864, 36864, 36864, 36864, 36864, 9216, 9216, 9216, 9216, 9216, 9216, 1024]
        self.b_index = 0
        ...
        self.classifier = quan_Linear(576, num_classes)
...
def resnet20_quan_stl10(num_classes=10):
...
def resnet32_quan_stl10(num_classes=10):
...
def resnet32_quan_stl101(num_classes=10):
    """Constructs a ResNet-32 model for CIFAR-10 (by default)
  Args:
    num_classes (uint): number of classes
  """
...
def resnet44_quan_stl10(num_classes=10):
...
def resnet56_quan_stl10(num_classes=10):
...
def resnet110_quan_stl10(num_classes=10):
