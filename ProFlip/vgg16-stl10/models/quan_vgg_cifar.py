...
def vgg16_quan(num_classes=10):#use bacthnorm, the same as vgg16_bn
    ...
    input_size = 96
    return VGG(make_layers(cfg['D'], add_output, num_classes, conv_channels, max_pool_sizes, fc_layer_sizes, input_size) )
...
def vgg16_quan1(num_classes=10):#use bacthnorm, the same as vgg16_bn
    ...
    fc_layer_sizes = [512, 512]
    input_size = 96
    return VGG1(make_layers(cfg['D'], add_output, num_classes, conv_channels, max_pool_sizes, fc_layer_sizes, input_size) )
