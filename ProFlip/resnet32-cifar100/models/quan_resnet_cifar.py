...
class CifarResNet(nn.Module):
  ...
  """
    ...
    """
        ...
        self.inplanes = 16
        self.branch_linearshape = torch.tensor([16384, 16384, 16384, 16384, 16384, 4096, 4096, 4096, 4096, 4096, 1024, 1024, 1024, 1024, 1024])
        self.b_index = 0
...
def resnet32_quan1(num_classes=100):
    """Constructs a ResNet-32 model for CIFAR-10 (by default)
  Args:
    num_classes (uint): number of classes
  """
