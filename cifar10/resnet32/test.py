...
pretrain_dict = torch.load('../model/cifar10/resnet32/our_robust/model_best.pth.tar')
        ...
        for i, (input, target) in enumerate(val_loader):
            ...
            for j in range(input.size(0)):
                ...
                for item in sorted(pre_index):#to do: no top 5
                    if out_list[item][1][j] > 0.93 or (c_ + 1 == num_c):
                        #item = -1
...
for param in net1.parameters():
    ...
    for param1 in net.parameters():
        ...
        if n==m:
            ...
            #if n==13 or n==33 or n==53 or n==73 or n==93 or n==113 or n==133 or n==163 or n==169 or n==179 or n==189 or n==199 or n==209 or n==217 or n==225:
            # if n==22 or n==46 or n==70 or n==94 or n==118 or n==142 or n==166 or n==190 or n==214 or n==238 or n==262 or n==286 or n==310 or n==334 or n==358 or n==368: #adaptive
