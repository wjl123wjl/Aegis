  ...
  """
    ...
    """
        ...
        self.branch_layer1 = nn.Sequential(
                              ...
                              quan_Conv2d(branch_channels[0], 
                              branch_channels[1], kernel_size=5,
                              stride=1, padding=2,
                              bias=False),
                              nn.BatchNorm2d(branch_channels[1]),
                              nn.ReLU(inplace=True),
                              nn.MaxPool2d(2, stride=2),
                              quan_Conv2d(branch_channels[1], branch_channels[2],
                              kernel_size=3,stride=1, padding=1,
                              bias=False),
                              nn.BatchNorm2d(branch_channels[2]),
                              nn.AvgPool2d(8),
                              View(-1, branch_channels[2]),
                              quan_Linear(32 * block.expansion, num_classes)
                              )
        ...
        self.branch_layer5 = nn.Sequential(
                              ...
                              quan_Linear(64 * block.expansion, num_classes)
                              )
